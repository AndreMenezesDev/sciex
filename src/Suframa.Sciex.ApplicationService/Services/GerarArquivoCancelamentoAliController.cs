...
namespace Suframa.Sciex.ApplicationService.Services
{
	...
	public class GerarArquivoCancelamentoAliController : ApiController
	{
		...
		public GerarArquivoCancelamentoAliController(IAliBll aliBll)
		{
			_aliBll = aliBll;
		...
		[AllowAnonymous]
		[HttpGet]
		public JsonResult<string> GerarArquivoCancelamentoAli(string hash)
		{
			try

			{
				...
				{
					string mensagem = _aliBll.GerarArquivoCancelamento();
