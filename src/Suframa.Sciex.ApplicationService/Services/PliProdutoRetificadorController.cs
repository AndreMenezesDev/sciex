...
namespace Suframa.Sciex.ApPliProdutocationService.Services
{
	...
	public class PliProdutoRetificadorController : ApiController
	{
		...
		public PliProdutoRetificadorController(IPliProdutoBll PliProdutoBll)
		{
		...
		{
			_PliProdutoBll.AtualizarProduto(PliProdutoVM);
			return PliProdutoVM;
		}
