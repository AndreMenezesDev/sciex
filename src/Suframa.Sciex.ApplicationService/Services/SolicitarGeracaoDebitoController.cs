...
namespace Suframa.Sciex.ApplicationService.Services
{
	...
	public class SolicitarGeracaoDebitoController : ApiController
	{
		private readonly ISolicitarGeracaoDebitoBll _solicitarGeracaoDebitoBll;

		/// <summary>Paridade Cambial injetar regras de negócio</summary>
		/// <param name="paridadeCambialBll"></param>
		public SolicitarGeracaoDebitoController(ISolicitarGeracaoDebitoBll solicitarGeracaoDebitoBll)
		{
			_solicitarGeracaoDebitoBll = solicitarGeracaoDebitoBll;
		...
		[AllowAnonymous]
		[HttpGet]
		public JsonResult<string> GerarDebito(string hash)
		{
			try
			{
				if (!string.IsNullOrEmpty(hash) && hash.ToUpper().Trim() == "A71E3FE602EA53827A3AB490709C94F4E13F84E90F6D07100F38052D22A99DF8F63E8BE20E2E753AC40F03C3B73B194555A79E8E717888525E5288298F53B7F1")
				{
					...
					_solicitarGeracaoDebitoBll.GerarDebito();
					return Json("Sucesso");
				}
				else
				{
