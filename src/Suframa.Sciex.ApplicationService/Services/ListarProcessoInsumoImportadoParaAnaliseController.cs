...
namespace Suframa.Sciex.ApplicationService.Services
{
	...
	public class ListarProcessoInsumoImportadoParaAnaliseController : ApiController
	{
		private readonly IProcessoInsumoSuframaBll _bll;

		public ListarProcessoInsumoImportadoParaAnaliseController(IProcessoInsumoSuframaBll bll)
		{
			_bll = bll;
		}
		...
		{
			return _bll.ListarDetalhesImportadosPorIdInsumoParaAnalise(vm);
		}		
