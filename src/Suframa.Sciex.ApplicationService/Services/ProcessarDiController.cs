...
namespace Suframa.Sciex.ApplicationService.Services
{
	...
	public class ProcessarDiController : ApiController
	{
		...
		public ProcessarDiController(IDiBll diBll)
		{
			_diBll = diBll;
		...
		[AllowAnonymous]
		[HttpGet]
		public JsonResult<string> ProcessarDi(string hash)
		{
			try
			{
				...
				{
					return Json(_diBll.ProcessarDI());					
				}
				else
				{
