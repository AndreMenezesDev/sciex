...
namespace Suframa.Sciex.ApplicationService.DropDown
{
	...
	public class RegimeTributarioListDropDownController : ApiController
	{
		...
		public RegimeTributarioListDropDownController(IRegimeTributarioBll regimeTributarioBll, IRegimeTributarioMercadoriaBll regimeTributarioMercadoriaBll)
		{
