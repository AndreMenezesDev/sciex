...
namespace Suframa.Sciex.ApplicationService.DropDown
{
	...
	public class ConsultarPliStatusDropDownController : ApiController
	{
		...
		public ConsultarPliStatusDropDownController(IPliStatusBll pliStatusBll)
		{
		...
		{
			return _pliStatusBll.ListarConsultarPli();
		}
	}
}