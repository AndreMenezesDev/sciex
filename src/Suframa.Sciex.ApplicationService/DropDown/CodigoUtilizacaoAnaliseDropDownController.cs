...
namespace Suframa.Sciex.ApplicationService.DropDown
{
	...
	public class CodigoUtilizacaoAnaliseDropDownController : ApiController
	{
		...
		public CodigoUtilizacaoAnaliseDropDownController(ICodigoUtilizacaoBll codigoUtilizacaoBll)
		{
		...
		{
			return _codigoUtilizacaoBll.ListarCodigoUtilizacao(codigoUtilizacaoVM);
		}
	}
}