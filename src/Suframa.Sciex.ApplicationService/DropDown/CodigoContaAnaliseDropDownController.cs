...
namespace Suframa.Sciex.ApplicationService.DropDown
{
	...
	public class CodigoContaAnaliseDropDownController : ApiController
	{
		...
		public CodigoContaAnaliseDropDownController(ICodigoContaBll codigoContaBll)
		{
		...
		{
			return _codigoContaBll.ListarCodigoConta(codigoContaVM);
		}
	}
}