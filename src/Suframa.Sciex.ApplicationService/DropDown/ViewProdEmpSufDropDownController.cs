...
namespace Suframa.Sciex.ApplicationService.DropDown
{
	...
	public class ViewProdEmpSufDropDownController : ApiController
	{
		private readonly IViewProdEmpSufBll _viewProdEmpSuf;

		public ViewProdEmpSufDropDownController(IViewProdEmpSufBll viewProdEmpSuf)
		{
		...
		{
			return _viewProdEmpSuf.ListarChaveProduto(vm);
		}
	}
}