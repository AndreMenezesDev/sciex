...
namespace Suframa.Sciex.ApplicationService.DropDown
{
	...
	public class ViewUndMedEmpSufDropDownController : ApiController
	{
		private readonly IViewProdEmpSufBll _viewProdEmpSuf;

		public ViewUndMedEmpSufDropDownController(IViewProdEmpSufBll viewProdEmpSuf)
		{
		...
		{
			return _viewProdEmpSuf.ListarChaveUnidadeMedida(vm);
		}
	}
}