...
namespace Suframa.Sciex.ApplicationService.DropDown
{
	...
	public class PliAplicacaoDropDownController : ApiController
	{
		...
		public PliAplicacaoDropDownController(IPliAplicacaoBll pliAplicacaoBll)
		{
		...
		{
			return _pliAplicacaoBll.Listar();
		}
	}
}