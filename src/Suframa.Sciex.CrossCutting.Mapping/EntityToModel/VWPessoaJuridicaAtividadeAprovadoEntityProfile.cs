...
{
	public class VWPessoaJuridicaAtividadeAprovadoEntityProfile : Profile
	{
		public VWPessoaJuridicaAtividadeAprovadoEntityProfile()
		{
			CreateMap<VWPessoaJuridicaAtividadeAprovadoEntity, AtividadePessoaJuridicaVM>()
				...
				.ForMember(dest => dest.CodigoSubClasseAtividade, opt => opt.MapFrom(src =>
