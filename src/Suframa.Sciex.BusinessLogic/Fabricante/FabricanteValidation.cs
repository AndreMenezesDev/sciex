...
namespace Suframa.Sciex.BusinessLogic
{
	...
	public abstract class FabricanteValidation<T> : AbstractValidator<T> where T : FabricanteDto
	{
		protected void ValidarFabricanteExisteRelacionamento()
		{
			RuleFor(c => c.TotalEncontradoFabricante)
				.Equal(0).WithErrorCode("ERR-112").WithMessage(Resources.RELACIONAMENTO_EXISTE);
		}

		protected void ValidarFabricanteExcluir()
		{
			RuleFor(c => c.TotalEncontradoFabricante)
