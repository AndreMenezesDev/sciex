...
{
    [Table("CADSUF_PESSOA_JURIDICA")]
    public partial class PessoaJuridicaEntity : BaseEntity, IData
    {
        ...
        public virtual ICollection<PessoaJuridicaAprovadoEntity> PessoaJuridicaAprovado { get; set; }
        ...
        public PessoaJuridicaEntity()
        {
            ...
            PessoaJuridicaAprovado = new HashSet<PessoaJuridicaAprovadoEntity>();
        }
    }
}