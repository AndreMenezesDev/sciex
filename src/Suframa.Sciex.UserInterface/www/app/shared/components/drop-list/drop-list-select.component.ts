...
@Component({
	...
	styleUrls: ['./drop-list-select.component.css'],
...
export class DropListSelectComponent implements OnInit, OnChanges {
	...
	@Output()
	limparObjetosAuxiliares: EventEmitter<string> = new EventEmitter<string>();
	...
	getMensagemInformacao() {
		var a = "Digite " + this.selMinimumInputLength + " ou mais caracteres";
		return a
	}
