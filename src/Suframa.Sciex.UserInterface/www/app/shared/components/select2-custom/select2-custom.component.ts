...
@Component({
  ...
  template: `<select #spanValue class="form-control" [disabled]="disabled" [required]="required"></select>`,
  styleUrls: ['./select2/select2.min.css'],
  encapsulation: ViewEncapsulation.None,
  providers: [customInputAccessor(Select2CustomComponent)]
})
// ControlValueAccessor: A bridge between a control and a native element.
export class Select2CustomComponent extends CustomInputComponent
