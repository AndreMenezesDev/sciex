...
@Component({
	...
	templateUrl: './formulario-detalhamento-ali-substitutivo.component.html',
})

export class ManterConsultarPliMercadoriasDetalheALISubstitutivoFormularioComponent implements OnInit {
