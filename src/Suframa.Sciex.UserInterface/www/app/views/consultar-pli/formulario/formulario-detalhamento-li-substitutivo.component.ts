...
@Component({
	selector: 'app-consultar-pli-mercadorias-li-substitutivo-formulario',
	templateUrl: './formulario-detalhamento-li-substitutivo.component.html',
})

export class ManterConsultarPliMercadoriasDetalheLISubstitutivoFormularioComponent implements OnInit {
	...
	public verificarRota() {
		...
		if (this.path == 'visualizar-detalhamento-li-substitutivo') {
			this.tituloPanel = 'Detalhamento da LI';
