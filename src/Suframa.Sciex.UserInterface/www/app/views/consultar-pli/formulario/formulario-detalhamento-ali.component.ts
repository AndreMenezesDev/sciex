...
@Component({
	selector: 'app-consultar-pli-mercadorias-ali-formulario',
	templateUrl: './formulario-detalhamento-ali.component.html',
})

export class ManterConsultarPliMercadoriasDetalheALIFormularioComponent implements OnInit {
	...
	AbrirALISubstituida(numeroALISubstituida){
		this.applicationService.get(this.servicoBuscaALISubstituida, numeroALISubstituida).subscribe( result  => {
			...
			var rota = "/consultar-pli/"+result+"/visualizar-detalhamento-ali/1"
