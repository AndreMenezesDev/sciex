...
@Component({
	selector: 'app-consultar-insumos-nacional-suframa-grid',
	templateUrl: './grid-insumos-nacional-suframa.component.html'
})

export class ConsultarInsumosNacionalSuframaGridComponent {
	...
	@ViewChild('appModalDetalheInsumo') appModalDetalheInsumo;
