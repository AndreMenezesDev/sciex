...
@Component({
	...
	templateUrl: './relatorio-certificado-registro-suframa.component.html',
	styleUrls:['./relatorio-certificado-registro-suframa.component.css']
})

export class RelatorioCertificadoRegistroSuframaComponent{
