...
@Component({
	selector: 'app-grid-modal-detalhe-processo-insumos-suframa',
	templateUrl: './grid-modal-detalhe-processo-insumos-suframa.component.html'
})

export class DetalheInsumosModalSuframaGridComponent {
