...
@Component({
	selector: 'app-consultar-processo-exportacao-suframa',
	templateUrl: './consultar-processo-exportacao-suframa.component.html'
})

@Injectable()
export class ConsultarProcessoExportacaoSuframaComponent implements OnInit {
	grid: any = { sort: {} };
	parametros: any = {};
	parametros1: any = {};
	ocultarFiltro: boolean = false;
	ocultarGrid: boolean = true;
	servicoGrid = 'ProcessoExportacaoSuframa';
	...
	constructor(
		...
		if (sameScreen != 'consultar-processo-exportacao-suframa'
				|| sameScreen == null
