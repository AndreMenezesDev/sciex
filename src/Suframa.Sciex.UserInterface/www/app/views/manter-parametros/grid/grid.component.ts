...
@Component({
	selector: 'app-manter-parametros-grid',
	templateUrl: './grid.component.html'
})

export class ManterParametrosGridComponent {
	...
	deletar(id) {
		this.applicationService.delete(this.servicoParametros, id).subscribe(result => {
