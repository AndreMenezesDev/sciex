...
@Component({
	selector: 'app-manter-listagem-exportacao',
	templateUrl: './manter-listagem-exportacao.component.html'
})

@Injectable()
export class ManterListagemExportacaoComponent implements OnInit {
	grid: any = { sort: {} };
	parametros: any = {};
	parametros1: any = {};
	ocultarFiltro: boolean = false;
	ocultarGrid: boolean = false;
	servicoGrid = 'LEProdutoGrid';
	somenteLeitura: boolean;
	@ViewChild('dataInicio') dataInicio;
    @ViewChild('dataFim') dataFim;
	@ViewChild('formBusca') formBusca;
	@ViewChild('codigoProdutoSuframa') codigoProdutoSuframa;
	...
	limpar() {
		...
		this.gravarBusca();
		this.codigoProdutoSuframa.clear();
		this.parametros.codigoProdutoSuframa = null;
