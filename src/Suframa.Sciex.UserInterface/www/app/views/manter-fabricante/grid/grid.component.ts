...
@Component({
	selector: 'app-manter-fabricante-grid',
	templateUrl: './grid.component.html'
})

export class ManterFabricanteGridComponent {
	...
	deletar(id) {
		this.applicationService.delete(this.servicoFabricante, id).subscribe(result => {
