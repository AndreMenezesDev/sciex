...
@Component({
	selector: 'app-manter-recinto-alfandega-grid',
...
export class ManterTipoEmbalagemGridComponent {
    ...
    constructor(
		private ManterRecintoAlfandegasComponent : ManterRecintoAlfandegasComponent,
	...
	ativarStatus(item) {
		...
		this.applicationService.put(this.servico, item).subscribe(result => {
			if (result != null) {
				...
				this.ManterRecintoAlfandegasComponent.listar();
			}
		});
	}
}  