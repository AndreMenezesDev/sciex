...
@Component({
	selector: 'app-manter-recinto-alfandega',
	templateUrl: './manter-recinto-alfandega.component.html'
})

@Injectable()

export class ManterRecintoAlfandegasComponent implements OnInit {
	...
	ngOnInit(): void {
		...
		if (this.parametros != undefined || this.parametros != null) {
			...
			this.parametros.titulo = "MANTER RECINTO DA ALFÂNDEGA";
			this.parametros.width = { 0: { columnWidth: 100 }, 1: { columnWidth: 680 } };
			this.parametros.columns = ["Código", "Descrição"];
			this.parametros.fields = ["codigo"/*|formatCode:7"*/, "descricao"];
		}
	...
	listar() {
		...
		this.codigo.nativeElement.value ? this.parametros.codigo = Number(this.codigo.nativeElement.value) : 
											this.parametros.codigo = -1;		
