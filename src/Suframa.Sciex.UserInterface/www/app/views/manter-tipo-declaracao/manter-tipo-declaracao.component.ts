...
@Component({
	selector: 'app-manter-tipo-declaracao',
	templateUrl: './manter-tipo-declaracao.component.html'
})

@Injectable()
export class ManterTipoDeclaracaoComponent implements OnInit {
	grid: any = { sort: {} };
	parametros: any = {};
	...
	ngOnInit(): void {
		...
		if (this.parametros != undefined || this.parametros != null) {
			...
			this.parametros = {};
			this.parametros.servico = this.servicoTipoDeclaracaoGrid;
			this.parametros.titulo = "MANTER TIPO DE DECLARAÇÃO";
