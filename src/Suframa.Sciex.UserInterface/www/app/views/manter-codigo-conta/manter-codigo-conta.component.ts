...
@Component({
	selector: 'app-manter-codigo-conta',
	templateUrl: './manter-codigo-conta.component.html'
})

@Injectable()
export class ManterCodigoContaComponent implements OnInit {
	grid: any = { sort: {} };
	parametros: any = {};
	...
	ngOnInit(): void {
		...
		if (this.parametros != undefined || this.parametros != null) {
			...
			this.parametros = {};
			this.parametros.servico = this.servicoCodigoContaGrid;
			this.parametros.titulo = "MANTER CÓDIGO CONTA";
