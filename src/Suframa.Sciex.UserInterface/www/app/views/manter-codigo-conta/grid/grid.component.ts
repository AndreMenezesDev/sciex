...
@Component({
	selector: 'app-manter-codigo-conta-grid',
	templateUrl: './grid.component.html'
})

export class ManterCodigoContaGridComponent {
	...
	ativarStatus(item) {
		...
		this.applicationService.put<manterCodigoContaVM>(this.servicoCodigoConta, item).subscribe(result => {
	...
	deletar(id) {
		this.applicationService.delete(this.servicoCodigoConta, id).subscribe(result => {
