...
@Component({
	selector: 'app-manter-plano-formulario-plano',
	templateUrl: './formularioPlano.component.html'
})

export class ManterPlanoFormularioPlanoComponent implements OnInit {
	path: string;
