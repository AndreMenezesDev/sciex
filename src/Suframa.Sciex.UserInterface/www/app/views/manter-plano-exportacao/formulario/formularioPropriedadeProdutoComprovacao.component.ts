...
@Component({
	...
	templateUrl: './formularioPropriedadeProdutoComprovacao.component.html'
})

export class ManterPlanoFormularioPropriedadeProdutoComprovacaoComponent implements OnInit {
	isCorrecao = false;
