...
@Component({
	selector: 'app-modal-editar-documento-due',
	templateUrl: './modal-editar-documento-due.component.html',
})

export class ModalEditarDocumentoDueComponent implements OnInit {
	model: any;
	formPai: any;
	servico = 'PEPais';
	parametros: any = {};
	...
	@ViewChild('appModalEditarDocumentoDueBackground') appModalEditarDocumentoDueBackground;
	...
	public abrir(formPai, item) {
		...
		this.model = item;
		this.appModalEditarDocumentoDue.nativeElement.style.display = 'block';
		this.appModalEditarDocumentoDueBackground.nativeElement.style.display = 'block';
	...
	public fechar() {
		this.appModalEditarDocumentoDue.nativeElement.style.display = 'none';
		this.appModalEditarDocumentoDueBackground.nativeElement.style.display = 'none';
    }
}
