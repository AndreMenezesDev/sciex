...
@Component({
	selector: 'app-grid-modal-insumos',
	templateUrl: './grid-modal-insumos.component.html'
})

export class InsumosModalGridComponent {
	...
	@Output() atualizarListaModal: EventEmitter<any> = new EventEmitter();
	...
	atualizarModel(){
		this.atualizarListaModal.emit(this.lista);
	}
