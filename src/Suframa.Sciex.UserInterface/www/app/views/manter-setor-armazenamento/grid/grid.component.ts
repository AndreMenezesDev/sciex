...
@Component({
	selector: 'app-manter-setor-armazenamento-grid',
	templateUrl: './grid.component.html'
})

export class SetorArmazenamentoGridComponent {

	servico = "SetorArmazenamento";

    constructor(
		private ManterSetorArmazenamentoComponent : ManterSetorArmazenamentoComponent,
	...
	ativarStatus(item) {
		...
		this.applicationService.put(this.servico, item).subscribe(result => {
			if (result != null) {
				...
				this.ManterSetorArmazenamentoComponent.listar();
			}
		});
	}
}  