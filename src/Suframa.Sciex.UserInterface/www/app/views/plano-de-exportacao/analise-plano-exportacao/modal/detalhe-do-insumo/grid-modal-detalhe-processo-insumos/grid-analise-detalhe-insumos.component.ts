...
@Component({
	selector: 'app-grid-modal-analise-detalhe-processo-insumos',
	templateUrl: './grid-analise-detalhe-insumos.component.html'
})

export class AnaliseDetalheInsumosModalGridComponent {
