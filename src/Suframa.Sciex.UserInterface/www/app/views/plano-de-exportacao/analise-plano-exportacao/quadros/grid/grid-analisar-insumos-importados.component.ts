...
@Component({
	selector: 'app-analisar-insumos-importados-grid',
	templateUrl: './grid-analisar-insumos-importados.component.html',
	styleUrls:['./grid-analisar-insumos.component.css']
})

export class AnalisarInsumosImportadosGridComponent {
	...
	exibirJustificativaReprovacao(item){
		this.appmodalJustificativaIndeferir.abrir(item,null, true);
	}
}
