...
@Component({
	selector: 'app-modal-justicar-indeferir',
	templateUrl: './modal-justificativa.component.html',
})

export class ModalJustificativaIndeferirComponent {

    parametros : any = {};
	servicoIndeferirPlanoExportacao = "IndeferirPlanoExportacao";
	formPai: any;
	...
	public abrir(dados,formPai,visualizar?) {
	...
	public salvar() {
		...
		this.applicationService.post(this.servicoIndeferirPlanoExportacao, this.parametros).subscribe((result:any) => {
			if (result.resultado){
