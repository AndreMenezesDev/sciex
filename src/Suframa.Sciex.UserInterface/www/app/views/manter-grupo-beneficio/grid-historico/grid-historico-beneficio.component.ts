...
@Component({
	selector: 'app-historico-beneficio-grid',
	templateUrl: './grid-historico-beneficio.component.html'
})

@Injectable()
export class BeneficioHistoricoGridComponent implements OnChanges {
