...
@Component({
	selector: 'app-manter-pli-formulario-comercializacao',
	templateUrl: './formularioComercializacao.component.html'
})

export class ManterPliFormularioComercializacaoComponent implements OnInit {
	path: string;
	titulo: string;
	tituloPanel: string;
	...
	public verificarRota() {
		...
		if (this.path == 'visualizarcomercializacao') {
		...
		else if (this.path == 'editarcomercializacao') {
			this.selecionar(this.route.snapshot.params['id']);
			this.titulo = 'Alterar';
			this.mostrarBotao = true;
		}
		else if (this.path == 'cadastrarcomercializacao') {
			this.selecionar(this.route.snapshot.params['id']);
