...
export class ManterPliFormularioSubstutivoComponent implements OnInit {
	...
	adicionarProduto() {
        ...
        if (this.listaProdutos.length > 0) {
            this.modal.alerta("Não e possivel adicionar mais de um Produto para PLI Substitutivo!", "");
            return;
        }
	...
	adicionarMercadoria(pliProduto) {
        ...
        if (this.grid.lista.length > 0) {
            this.modal.alerta("Não e possivel adicionar mais de um NCM para PLI Substitutivo!", "");
            return;
        }
