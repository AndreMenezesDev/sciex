...
@Component({
	...
	templateUrl: './formulario-cancelar-detalhamento-li.component.html',
})

export class CancelaLIFormularioLIFormularioComponent implements OnInit {
	...
	AbrirLISubstituida(numeroALISubstituida){
		...
		var rota = "/manter-cancelar-li/"+numeroALISubstituida+"/visualizar-detalhamento-li-substitutivo";
