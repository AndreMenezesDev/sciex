...
@Component({
	selector: 'app-consultar-protocolo-envio-pli-grid',
	templateUrl: './grid-envio-pli.component.html'
})

@Injectable()
export class ManterConsultarProtocoloEnvioPliGridComponent implements OnInit {
