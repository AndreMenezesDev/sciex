...
@Component({
	selector: 'app-analisar-listagem-exportacao',
	templateUrl: './analisar-listagem-exportacao.component.html'
})

@Injectable()
export class AnalisarListagemExportacaoComponent implements OnInit {
	grid: any = { sort: {} };
	parametros: any = {};
	parametros1: any = {};
	ocultarFiltro: boolean = false;
	ocultarGrid: boolean = false;
	servicoGrid = 'LEAnaliseProdutoGrid';
