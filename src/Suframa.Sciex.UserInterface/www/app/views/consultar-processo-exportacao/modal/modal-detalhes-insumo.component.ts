...
@Component({
	selector: 'app-modal-detalhes-insumo',
	templateUrl: './modal-detalhes-insumo.component.html',
})

export class ModalDetalhesInsumoComponent {	
	modelProduto: any = {};
	grid: any = { sort: {} };
	isQuadroNacional: boolean;
	servico = 'ListarProcessoInsumosNacionalOuImportadoPorIdInsumo';
