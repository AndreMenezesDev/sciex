...
@Component({
	selector: 'app-grid-modal-detalhe-processo-insumos',
	templateUrl: './grid-modal-detalhe-processo-insumos.component.html'
})

export class DetalheInsumosModalGridComponent {
