...
@Component({
	selector: 'app-manter-unidade-receita-federal-grid',
	templateUrl: './grid.component.html'
})

export class ManterUnidadeReceitaFederalGridComponent {
	...
	deletar(id) {
		this.applicationService.delete(this.servicoUnidadeReceitaFederal, id).subscribe(result => {
