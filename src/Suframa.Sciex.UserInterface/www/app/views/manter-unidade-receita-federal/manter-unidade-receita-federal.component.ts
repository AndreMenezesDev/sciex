...
@Component({
	selector: 'app-manter-unidade-receita-federal',
	templateUrl: './manter-unidade-receita-federal.component.html'
})

@Injectable()
export class ManterUnidadeReceitaFederalComponent implements OnInit {
	grid: any = { sort: {} };
	parametros: any = {};
	...
	ngOnInit(): void {
		...
		if (this.parametros != undefined || this.parametros != null) {
			...
			this.parametros = {};
			this.parametros.servico = this.servicoUnidadeReceitaFederalGrid;
			this.parametros.titulo = "MANTER UNIDADE DA RECEITA FEDERAL DO BRASIL";
