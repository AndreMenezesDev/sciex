...
@Component({
	selector: 'app-manter-naladi',
	templateUrl: './manter-naladi.component.html'
})

@Injectable()
export class ManterNaladiComponent implements OnInit {
	grid: any = { sort: {} };
	parametros: any = {};
	...
	ngOnInit(): void {
		...
		if (this.parametros != undefined || this.parametros != null) {
			...
			this.parametros = {};
			this.parametros.titulo = "NALADI"
			this.parametros.servico = this.servicoNaladiGrid;
			this.parametros.width = { 0: { columnWidth: 100 }, 1: { columnWidth: 660 } };
			this.parametros.columns = ["Código", "Descrição"];
			this.parametros.fields = ["codigo|formatCode:8", "descricao"];
		}
