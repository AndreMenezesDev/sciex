...
{
	public class DesignarSolicitacaoVM : PagedOptions
	{
		public int? InscricaoCadastral { get; set; }
		public string RazaoSocial { get; set; }
		public string NumeroAnoSolicitacao { get; set; }
		public string NumeroAnoProcesso { get; set; }
		public string NumeroProcesso { get; set; }
		public string AnoProcesso { get; set; }
		public string Solicitacao { get; set; }
		public string AnoSolicitacao { get; set; }
